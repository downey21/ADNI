#!/bin/bash
#SBATCH --job-name=slurm_Axial_rsfMRI__Eyes_Open_make_tensor_Together
#SBATCH --partition=cpu
#SBATCH --nodelist=node01
#SBATCH --cpus-per-task=4
#SBATCH --mem=0
#SBATCH --time=3-23:59:59
#SBATCH --output=slurm_Axial_rsfMRI__Eyes_Open_make_tensor_Together.log
#SBATCH --error=slurm_Axial_rsfMRI__Eyes_Open_make_tensor_Together.log

# sudo sbatch slurm_Axial_rsfMRI__Eyes_Open_make_tensor_Together.sh
...
docker run --rm \
    ...
    bash -i -c "source ~/.bashrc && \
                ...
                Rscript /root/Project/ADNI/Tensor/make_tensor_Together.R"
