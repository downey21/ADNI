#!/bin/bash
#SBATCH --job-name=slurm_Axial_rsfMRI__Eyes_Open_make_tensor_CN
#SBATCH --partition=cpu
#SBATCH --nodelist=node01
#SBATCH --cpus-per-task=4
#SBATCH --mem=0
#SBATCH --time=3-23:59:59
#SBATCH --output=slurm_Axial_rsfMRI__Eyes_Open_make_tensor_CN.log
#SBATCH --error=slurm_Axial_rsfMRI__Eyes_Open_make_tensor_CN.log

# sudo sbatch slurm_Axial_rsfMRI__Eyes_Open_make_tensor_CN.sh
...
docker run --rm \
    ...
    bash -i -c "source ~/.bashrc && \
                ...
                Rscript /root/Project/ADNI/Tensor/make_tensor_CN.R"
